...
namespace NLite.Data.Common
{
    ...
    public class MethodMapping
    {
        ...
        static MethodMapping()
        {
            ...
            Mappings[Member(() => NLite.StringExtensions.LeftOf("", ' '))] = Lambda<string, char?, string>((obj, p0) => SqlFunctions.LeftOf(obj, p0.ToString()));
            Mappings[Member(() => NLite.StringExtensions.LeftOf("", ""))] = Lambda<string, string, string>((obj, p0) => SqlFunctions.LeftOf(obj, p0));
            Mappings[Member(() => NLite.StringExtensions.RightOf("", ' '))] = Lambda<string, char?, string>((obj, p0) => SqlFunctions.RightOf(obj, p0.ToString()));
            Mappings[Member(() => NLite.StringExtensions.RightOf("", ""))] = Lambda<string, string, string>((obj, p0) => SqlFunctions.RightOf(obj, p0));
