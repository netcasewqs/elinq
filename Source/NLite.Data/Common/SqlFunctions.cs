...
namespace NLite.Data.Common
{
    public sealed class SqlFunctions
    {
        ...
        //changed
        internal static bool Like(string str, string value, bool hasStart, bool hasEnd, bool hasEscape)
        {
        ...
        {
            return str == null || value == null ? null : NLite.StringExtensions.RightOf(str, value);
        }
