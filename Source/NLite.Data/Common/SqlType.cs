...
using System.Diagnostics;
    ...
    public sealed class SqlType
    {
        ...
        static SqlType()
        {
            ...
            defaultTypes[Types.Char.TypeHandle.Value.GetHashCode()] = new SqlType(DBType.NChar, length: 1);
            ...
            defaultTypes[Types.String.TypeHandle.Value.GetHashCode()] = new SqlType(DBType.NVarChar, length: 255);
            ...
            defaultTypes[typeof(char?).TypeHandle.Value.GetHashCode()] = new SqlType(DBType.NChar, length: 1);
